function [gamma1_v,gamma2_v,Ge1_v,Ge2_v] = CG_Vapor(ydata,Tdata,g1,g2,n1,n2,Ng1,Ng2,R,N,M)
QkCH3=1.2958;
QkCH2=0.9471;
QkCH=0.2629;
QkCHd=1.3221;
...
for u=1:max(size(ydata))
    Xti=ydata(u).*n1+(1-ydata(u)).*n2;
    Xtotal=sum(Xti);
    XCH3(u)=(ydata(u).*n1(1)+(1-ydata(u)).*n2(1))/Xtotal;
    XCH2(u)=(ydata(u).*n1(2)+(1-ydata(u)).*n2(2))/Xtotal;
    XCH(u)=(ydata(u).*n1(3)+(1-ydata(u)).*n2(3))/Xtotal;
    XCHd(u)=(ydata(u).*n1(4)+(1-ydata(u)).*n2(4))/Xtotal;
    XOHp(u)=(ydata(u).*n1(5)+(1-ydata(u)).*n2(5))/Xtotal;
    XOHs(u)=(ydata(u).*n1(6)+(1-ydata(u)).*n2(6))/Xtotal;
    XCH3OH(u)=(ydata(u).*n1(7)+(1-ydata(u)).*n2(7))/Xtotal;
    XH2O(u)=(ydata(u).*n1(8)+(1-ydata(u)).*n2(8))/Xtotal;
    XCH3CO(u)=(ydata(u).*n1(9)+(1-ydata(u)).*n2(9))/Xtotal;
    XCH2COO(u)=(ydata(u).*n1(10)+(1-ydata(u)).*n2(10))/Xtotal;
    XCO2(u)=(ydata(u).*n1(11)+(1-ydata(u)).*n2(11))/Xtotal;
    XIM_Tf2N(u)=(ydata(u).*n1(12)+(1-ydata(u)).*n2(12))/Xtotal;
    XIM_PF6(u)=(ydata(u).*n1(13)+(1-ydata(u)).*n2(13))/Xtotal;
    XIM_BF4(u)=(ydata(u).*n1(14)+(1-ydata(u)).*n2(14))/Xtotal;
end
X1puro=n1/Ng1;
X2puro=n2/Ng2;
%Componente 1
...
for u=1:max(size(ydata))
    ...
    gamma1_v(u)=exp(ln_gamma1);
    gamma2_v(u)=exp(ln_gamma2);
    Ge1_v(u)=R.*Tdata.*log(gamma1_v(u));
    Ge2_v(u)=R.*Tdata.*log(gamma2_v(u));
end